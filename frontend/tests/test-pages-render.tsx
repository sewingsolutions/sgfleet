...
vi.mock('../src/hooks/useUserStats', () => ({
  ...
  useFleetStats: vi.fn(() => ({ data: { labels: ['a'], total_requests: 0, avg_latency: 0, total_429: 0, total_prompt_tokens: 0, total_completion_tokens: 0, users: [], latency_p50: [], latency_p95: [], count_429: [] }, isLoading: false })),
}))
