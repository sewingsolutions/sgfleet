...
describe('useLogs', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(api.getLogs).mockResolvedValue([
      { id: 1, timestamp: '2024-01-01T00:00:00Z', level: 'INFO', event: null, method: null, path: null, status: null, latency_ms: null, user: null, request_id: null, ip: null, error: null, message: null },
    ])
  })
  ...
  it('auto-refresh interval invalidates queries', async () => {
    ...
    expect(invalidateSpy).toHaveBeenCalledWith(
      expect.objectContaining({ queryKey: ['logs'] })
    )
