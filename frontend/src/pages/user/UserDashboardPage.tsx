    ...
    <UserLayout>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link
            to="/user/models"
            className="px-4 py-3 bg-gray-50 dark:bg-slate-700 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-600 transition text-center"
          >
            View Models
          </Link>
          <Link
