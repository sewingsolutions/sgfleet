  ...
  return (
    <div className={`${card} ${cardBg}`}>
      <div className="flex items-start justify-between">
        ...
        <div className={`flex items-center justify-center w-12 h-12 rounded-lg ${color}`}>{icon}</div>
      </div>
    </div>
  );
}
...
function UnicornSVG() {
  return (
    ...
    >
      ...
      {/* Ear */}
      <path
        d="M62 36C62 36 65 28 68 30C70 32 66 38 66 38"
        className="fill-gray-100 dark:fill-slate-200"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      {/* Eye - happy */}
      <path
        d="M46 43C46 43 48 46 50 43"
        className="stroke-gray-700 dark:stroke-slate-600"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
      />
      ...
      {/* Mane */}
      <path
        d="M66 38C72 35 78 38 75 48C72 55 68 52 68 52"
      ...
      />
      <path
        d="M65 50C72 48 78 52 75 62C72 68 66 64 66 64"
      ...
      />
      <path
        d="M62 64C68 62 74 66 72 76C69 82 62 78 62 78"
        className="fill-fuchsia-300 dark:fill-fuchsia-400"
        stroke="fuchsia"
        strokeWidth="1"
        opacity="0.7"
      />
      <path
        d="M58 78C64 76 70 80 68 90C65 96 58 92 58 92"
        className="fill-violet-300 dark:fill-violet-400"
        stroke="violet"
        strokeWidth="1"
        opacity="0.7"
      ...
      {/* Tail */}
      <path
        d="M172 130C182 128 188 135 185 145C182 155 178 152 178 152"
        className="fill-fuchsia-300 dark:fill-fuchsia-400"
        stroke="fuchsia"
        strokeWidth="1"
        opacity="0.7"
      />
      <path
        d="M172 135C180 135 186 142 184 150"
        className="fill-violet-300 dark:fill-violet-400"
        stroke="violet"
        strokeWidth="1"
        opacity="0.7"
      ...
      {/* Belly highlight */}
      <path
        d="M82 130C100 126 130 126 155 130"
        className="stroke-white dark:stroke-slate-100"
        strokeWidth="1.5"
        strokeLinecap="round"
        opacity="0.5"
        fill="none"
